...
def main(
    ...
    path_to_X_train: Path = typer.Option(default=...),
    path_to_X_test: Path = typer.Option(default=...),
    path_to_y_train: Path = typer.Option(default=...),
    path_to_y_test: Path = typer.Option(default=...),
